...
def vectorizing_state(state, done, truncated, device):      # Reminder: change this for your specific task ⚠️⚠️⚠️
    ...
    state_1 = quantifying(-1, 1, 25,      -1,      1 , state[0], device)
    state_2 = quantifying(-1, 1, 25,      -1,      1 , state[1], device)
    state_3 = quantifying(-1, 1, 25,      -1,      1 , state[2], device)
    state_4 = quantifying(-1, 1, 25,      -1,      1 , state[3], device)
    state_5 = quantifying(-1, 1, 25, -12.567, 12.567 , state[4], device)
    state_6 = quantifying(-1, 1, 25, -28.274, 28.274 , state[5], device)
